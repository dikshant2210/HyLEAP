...
public class StartupISDESPOTpred {
    ...
    public static void main(String[] args){
        ...
        for(int i = 0; i < MAX_INSTANCES; ++i){
            try {
                ...
                ProcessBuilder pb = new ProcessBuilder("ISDESPOT/isdespot-ped-pred/is-despot/problems/isdespotp_car/car", String.valueOf(START_PORT + MAX_INSTANCES + i));
                //pb.redirectErrorStream(true);
                File output = new File("tools/output.txt");
